...
if &t_Co == 88 || &t_Co == 256 || has("gui_running")
    ...
    call <SID>X('Conceal',          '',         '',         '')
    call <SID>X('CursorColumn',     'NONE',     '3a3a3a',   'NONE')
    call <SID>X('CursorLine',       'NONE',     '3a3a3a',   'NONE')
    call <SID>X('Directory',        '5f87ff',   'NONE',     'bold')
    call <SID>X('ErrorMsg',         'ffffff',   'ff0000',   'NONE')
    call <SID>X('LineNr',           '626262',   'NONE',     'NONE')
    ...
    call <SID>X('StatusLineNC',     'aaaaaa',   '222222',   'NONE')
    call <SID>X('TabLine',          'NONE',     '222222',   'NONE')
    call <SID>X('TabLineSel',       '000000',   'f0b050',   'NONE')
    call <SID>X('TabLineFill',      'NONE',     '222222',   'NONE')
    call <SID>X('Title',            'ff00ff',   'NONE',     'bold')
    call <SID>X('VertSplit',        '222222',   '222222',   'NONE')
    call <SID>X('Visual',           'NONE',     '505050',   'NONE')
    call <SID>X('VisualNOS',        'NONE',     '262626',   'underline')
    ...
    " Diff
    call <SID>X('DiffAdd',          'ffffff',   '008700',   'NONE')
    call <SID>X('DiffChange',       'NONE',     '005f5f',   'NONE')
    call <SID>X('DiffDelete',       'ffffff',   '870000',   'NONE')
    call <SID>X('DiffText',         'ffffff',   '008787',   'NONE')

    " Search
    call <SID>X('IncSearch',        '000000',   'ffff00',   'NONE')
    call <SID>X('Search',           '000000',   'ffff00',   'NONE')
    ...
    call <SID>X('Comment',          '808080',   'NONE',     'NONE')
    call <SID>X('Constant',         '8787d7',   'NONE',     'NONE')
    call <SID>X('Identifier',       '87d787',   'NONE',     'NONE')
    call <SID>X('Statement',        'd7d75f',   'NONE',     'bold')
    ...
    call <SID>X('Function',         'd70000',   '',         'bold')
    ...
    "call <SID>X('String',           'b0b0ff',   'NONE',     'NONE')
    "call <SID>X('Number',           '60ff60',   'NONE',     'NONE')
    "call <SID>X('Boolean',          'ffb0ff',   'NONE',     'NONE')
    "call <SID>X('Function',         'ff0000',   'NONE',     'bold')
    "call <SID>X('Operator',         'a0c0a0',   'NONE',     'bold')
    "call <SID>X('Macro',            'f0f0a0',   'NONE',     'bold')
