...
if &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Comment",          "808080",       "",         "")
    call <SID>X("Constant",         "ff5050",       "",         "")
    call <SID>X("String",           "b0b0ff",       "",         "")
    " Character
    call <SID>X("Number",           "60ff60",       "",         "")
    call <SID>X("Boolean",          "ffb0ff",       "",         "")
    " Float
    call <SID>X("Identifier",       "008b8b",       "",         "")
    call <SID>X("Function",         "ff0000",       "",         "bold")
    call <SID>X("Statement",        "d0d080",       "",         "bold")
    " Conditional
    " Repeat
    " Label
    call <SID>X("Operator",         "a0c0a0",       "",         "bold")
    " Keyword
    " Exeption
    call <SID>X("PreProc",          "a020f0",       "",         "")
    " Include
    " Define
    call <SID>X("Macro",            "f0f0a0",       "",         "bold")
    " PreCondit
