...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, altkey            }, "F8",  function () exec(home .. "/bin/squeezebox.sh next") end),
    awful.key({ modkey, altkey            }, "F9",  function () exec(home .. "/bin/squeezebox.sh toggle_play") end),
