...
-- {{{ Main
theme = {}
theme.path = os.getenv( "HOME" ) .. "/.config/awesome/themes/zoop"
...
theme.fg_minimize = theme.colors.base01
...
-- {{{ Icons
-- {{{ Taglist
theme.taglist_squares_sel   = theme.path .. "/taglist/triangle.png"
theme.taglist_squares_unsel = theme.path .. "/taglist/triangle.png"
